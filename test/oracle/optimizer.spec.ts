...
describe("oracle ring-3: optimizer parity (cpu)", () => {
  test(
    "one-step SGD update matches PyTorch grads",
    { timeout: 30000 },
    async () => {
  ...
  test(
    "weight decay update matches PyTorch grads",
    { timeout: 30000 },
    async () => {
      const api = new Torchlette("cpu");
      const lr = 0.1;
  ...
  test(
    "momentum update matches PyTorch grads over two steps",
    { timeout: 30000 },
    async () => {
      const api = new Torchlette("cpu");
      const lr = 0.1;
  ...
  test(
    "one-step Adam update matches PyTorch grads",
    { timeout: 30000 },
    async () => {
      const api = new Torchlette("cpu");
      const lr = 0.1;
  ...
  test(
    "Adam state matches PyTorch grads over two steps",
    { timeout: 30000 },
    async () => {
      const api = new Torchlette("cpu");
      const lr = 0.1;
