...
describe("Checkpoint Memory Profile", () => {
  ...
  it(
    "profiles memory at each phase WITHOUT checkpoint",
    { timeout: 120000 },
    async () => {
      if (!webgpuAvailable) {
      ...
      console.log(
        `[2] After Torchlette init: ${(m1 / 1e6).toFixed(2)} MB (+${((m1 - m0) / 1e6).toFixed(2)})`,
      );
      ...
      console.log(
        `[3] After model init: ${(m2 / 1e6).toFixed(2)} MB (+${((m2 - m1) / 1e6).toFixed(2)})`,
      );
      ...
      console.log(
        `[4] After input creation: ${(m3 / 1e6).toFixed(2)} MB (+${((m3 - m2) / 1e6).toFixed(2)})`,
      );
      ...
      console.log(
        `[5] After forward: ${(m4 / 1e6).toFixed(2)} MB (+${((m4 - m3) / 1e6).toFixed(2)}), Peak: ${(peak4 / 1e6).toFixed(2)} MB`,
      );
      ...
      console.log(
        `[6] After loss.sum(): ${(m5 / 1e6).toFixed(2)} MB (+${((m5 - m4) / 1e6).toFixed(2)})`,
      );
      ...
      console.log(
        `[7] After backward: ${(m6 / 1e6).toFixed(2)} MB (+${((m6 - m5) / 1e6).toFixed(2)}), Peak: ${(peak6 / 1e6).toFixed(2)} MB`,
      );
      ...
      console.log(
        `[8] After markStep: ${(m7 / 1e6).toFixed(2)} MB (+${((m7 - m6) / 1e6).toFixed(2)}), Final Peak: ${(peakFinal / 1e6).toFixed(2)} MB`,
      );
      ...
      console.log(
        `  Backward allocations: ~${((m6 - m5) / 1e6).toFixed(2)} MB`,
      );
  ...
  it(
    "profiles memory at each phase WITH checkpoint",
    { timeout: 120000 },
    async () => {
      if (!webgpuAvailable) {
        console.log("Skipping: WebGPU not available");
      ...
      const peak4 = gpuMemoryTracker.getPeakUsageBytes();
      console.log(
        `[5] After forward (checkpointed): ${(m4 / 1e6).toFixed(2)} MB (+${((m4 - m3) / 1e6).toFixed(2)}), Peak: ${(peak4 / 1e6).toFixed(2)} MB`,
      );
      ...
      const peak6 = gpuMemoryTracker.getPeakUsageBytes();
      console.log(
        `[7] After backward (with recomputation): ${(m6 / 1e6).toFixed(2)} MB (+${((m6 - m5) / 1e6).toFixed(2)}), Peak: ${(peak6 / 1e6).toFixed(2)} MB`,
      );
  ...
  it("compares phase-by-phase memory usage", { timeout: 240000 }, async () => {
    ...
    console.log("|-------|---------------|-----------------|------|");
    console.log(
      `| Forward alloc | ${((postForward1 - preForward1) / 1e6).toFixed(2)} MB | ${((postForward2 - preForward2) / 1e6).toFixed(2)} MB | ${((postForward2 - preForward2 - (postForward1 - preForward1)) / 1e6).toFixed(2)} MB |`,
    );
    console.log(
      `| Forward peak | ${(peakForward1 / 1e6).toFixed(2)} MB | ${(peakForward2 / 1e6).toFixed(2)} MB | ${((peakForward2 - peakForward1) / 1e6).toFixed(2)} MB |`,
    );
    console.log(
      `| Backward alloc | ${((postBackward1 - preBackward1) / 1e6).toFixed(2)} MB | ${((postBackward2 - preBackward2) / 1e6).toFixed(2)} MB | ${((postBackward2 - preBackward2 - (postBackward1 - preBackward1)) / 1e6).toFixed(2)} MB |`,
    );
    console.log(
      `| **Total peak** | **${(peakTotal1 / 1e6).toFixed(2)} MB** | **${(peakTotal2 / 1e6).toFixed(2)} MB** | **${((peakTotal2 - peakTotal1) / 1e6).toFixed(2)} MB** |`,
    );
    ...
    console.log(`\nBreakdown:`);
    console.log(
      `  Forward peak savings: ${(forwardSavings / 1e6).toFixed(2)} MB`,
    );
    ...
    if (peakTotal2 > peakForward2) {
      ...
      console.log(
        `  Backward spike above forward: ${(backwardSpike / 1e6).toFixed(2)} MB`,
      );
