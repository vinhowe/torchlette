...
| 4 | Compile-from-IR with graph-liveness memory planning; recording demoted to cross-check — **DESIGN COMMITTED 2026-06-12: `docs/stage4-compile-from-ir.md`** (phases 0–4, each shippable behind a command-stream differential; phase 1 = memory planner against recorded streams, expected to close the foreach gap and unblock stage 3's default flip) | replaces arena + record-hooks; fixes medium/124M memory at compiled speed; absorbs parked planned-buffers |
