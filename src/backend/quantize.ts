 ...
 *
 * See docs/quantization-design.md. Graduated to src/ (phase 2, task #93): a
 * pure host function now used by BOTH the Node loader path and the browser
 * loader (the "second model / browser" that earns generality). tools/quantize.ts
 * re-exports it for the phase-1 gate scripts.
 *
